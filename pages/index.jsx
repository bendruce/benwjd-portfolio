...
export default function Page() {
  ...
  return (
    ...
    transition-opacity duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}
      >
        <div
          className={`font-bold text-xl sm:text-3xl  lg:text-8xl  text-center transition-opacity duration-1000 text-light-text ${
        ...
        <div
          className={` text-base sm:text-xl  lg:text-5xl text-center transition-opacity duration-1000 text-light-text ${
  ...
  transition-opacity duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}
      >
        <div className="flip-card w-full    sm:min-h-[50vh] h-96">
          <div className="flip-card-inner relative w-full h-full">
            <div className="flip-card-front absolute w-full h-full bg-background-dark3 flex flex-col sm:p-12 justify-center items-center border-4 border-solid border-red-300  rounded-xl  sm:min-h-[50vh] sm:h-96  p-4  gap-4 sm:gap-12">
              <div className="flex flex-col justify-center items-center gap-4 sm:gap-12">
                ...
                <div className="text-red-300  font-bold lg:text-3xl text-center">
                  <h1 className="text-lg">Software Developer</h1>
                  <h2 className="lg:hidden text-base animate-breathe">
                    Click Me
                  </h2>
                </div>
              </div>
          ...
          <div className="flip-card-inner relative w-full h-full">
            <div className="flip-card-front absolute w-full h-full bg-background-dark3 flex flex-col sm:p-12 justify-center items-center border-4 border-solid border-react-color  rounded-xl  sm:min-h-[50vh] sm:h-96  p-4  gap-4 sm:gap-12">
              <div className="flex flex-col justify-center items-center gap-4 sm:gap-8">
                ...
                <div className="text-react-color  font-bold lg:text-3xl text-center">
                  <h1 className="text-lg">Web & App Development</h1>
                  <h2 className="lg:hidden text-base animate-breathe">
                    Click Me
                  </h2>
                </div>
            ...
            <div className="flip-card-back  absolute w-full h-full bg-background-dark3 flex flex-col p-12 justify-center items-center border-4 border-solid border-react-color  rounded-xl">
              <div className="Description font-bold text-sm lg:text-xl">
                <h1>
                  Experienced in front and back end development for Web
                  Development and App Design. Proficient at Node.js, React,
          ...
          <div className="flip-card-inner relative w-full h-full ">
            <div className="flip-card-front absolute w-full h-full bg-background-dark3 flex flex-col sm:p-12 justify-center items-center border-4 border-solid border-custom-lboro rounded-xl  sm:min-h-[50vh] sm:h-96  p-4  gap-4 sm:gap-12">
              <div className="flex flex-col justify-center items-center gap-4 sm:gap-8">
                ...
                <div className="text-custom-lboro   font-bold lg:text-3xl text-center">
                  <h1 className="text-lg">Computer Science Student</h1>
                  <h2 className="lg:hidden text-base animate-breathe">
                    Click Me
                  </h2>
                </div>
            ...
            <div className="flip-card-back  absolute w-full h-full bg-background-dark3 flex flex-col p-12 justify-center items-center border-4 border-solid border-custom-lboro  rounded-xl">
              <div className="Description font-bold text-sm lg:text-base xl:text-xl">
                <h1>
    ...
    transition-opacity  ${isLoaded ? "opacity-100" : "opacity-0"}`}
      >
        <div className="flip-card w-full sm:min-h-[50vh] h-96">
          <div className="flip-card-inner relative w-full h-full">
            <div className="flip-card-front absolute w-full h-full bg-background-dark3 flex flex-col sm:p-12 justify-center items-center border-4 border-solid border-black rounded-xl  sm:min-h-[50vh] sm:h-96  p-4  gap-4 sm:gap-12">
              <div className="flex flex-col justify-center items-center gap-4 sm:gap-12">
                <img
                ...
                <div className="text-black font-bold lg:text-3xl text-center">
                  <h1 className="text-lg">Movement Clinics</h1>
                  <h2 className="lg:hidden text-base animate-breathe">
                    Click Me
                  </h2>
                </div>
        ...
        <div className="flip-card w-full   sm:min-h-[50vh] h-96">
          <div className="flip-card-inner relative w-full h-full">
            <div className="flip-card-front absolute w-full h-full bg-background-dark3 flex flex-col sm:p-12 justify-center items-center border-4 border-solid border-sigma-color rounded-xl  sm:min-h-[50vh] sm:h-96  p-4  gap-4 sm:gap-12">
              <div className="flex flex-col justify-center items-center gap-4 sm:gap-12">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-8/12"
                ...
                <div className="text-sigma-color font-bold lg:text-3xl text-center">
                  <h1 className="text-lg">App Development Module</h1>
                  <h2 className="lg:hidden text-base animate-breathe">
                    Click Me
                  </h2>
                </div>
        ...
        <div className="flip-card w-full    sm:min-h-[50vh] h-96">
          <div className="flip-card-inner relative w-full h-full">
            <div className="flip-card-front absolute w-full h-full bg-background-dark3 flex flex-col sm:p-12 justify-center items-center border-4 border-solid border-purple-300 rounded-xl  sm:min-h-[50vh] sm:h-96  p-4  gap-4 sm:gap-12">
              <div className="flex flex-col justify-center items-center gap-4 sm:gap-12">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-8/12"
                ...
                <div className="text-purple-300 font-bold lg:text-3xl text-center">
                  <h1 className="text-lg">Team Projects Module</h1>
                  <h2 className="lg:hidden text-base animate-breathe">
                    Click Me
                  </h2>
                </div>
            ...
            <div className="flip-card-front absolute w-full h-full bg-background-dark3 flex flex-col sm:p-12 justify-center items-center border-4 border-solid border-green-600 rounded-xl  sm:min-h-[50vh] sm:h-96  p-4  gap-4 sm:gap-12">
              <div className="flex flex-col justify-center items-center gap-4 sm:gap-12">
                <img
                  ...
                  className="w-8/12  rounded shadow mr-3"
                ></img>
                <div className="text-green-600 font-bold lg:text-3xl text-center">
                  <h1 className="text-lg">Leaf Life Saver</h1>
                  <h2 className="lg:hidden text-base animate-breathe">
                    Click Me
                  </h2>
                </div>
